// source: https://github.com/TrueFiEng/Waffle/blob/master/waffle-compiler/src/config/config.ts
// TEMP: this doesn't even need to exist, just leaving it for reference 
